...
async def create_intermediate_user_project(
    db: AsyncSession, intermediate_user_project_create: intermediate_user_project_schema.IntermediateUserProjectCreateRequest
...
async def get_intermediate_user_projects(db: AsyncSession) -> List[Tuple[str]]:
    result: Result = await(
        db.execute(
            select(
...
async def get_intermediate_user_project(db: AsyncSession, intermediate_user_project_id: int) -> Optional[intermediate_user_project_model.IntermediateUserProject]:
...
async def get_intermediate_user_project_by_user_and_project(db: AsyncSession, user_id: int, project_id) -> Optional[intermediate_user_project_model.IntermediateUserProject]:
    result: Result = await db.execute(
...
async def update_intermediate_user_project(
    db: AsyncSession, intermediate_user_project_create: intermediate_user_project_schema.IntermediateUserProjectUpdateRequest,
...
async def delete_intermediate_user_project(db: AsyncSession, original: intermediate_user_project_model.IntermediateUserProject) -> None:
